macro(myproj_add_hardening_flags target visibility)
    ...
    if(MSVC)
        ...
        if(myproj_ENABLE_DEBUG_OPTIMIZATION)
        ...
        check_cxx_compiler_flag("-fcf-protection=full" myproj_FCF_PROTECTION)
        if(myproj_FCF_PROTECTION)
            target_compile_options(${target} ${visibility} "-fcf-protection=full")
        endif()
        # -mbranch-protection is for Aarch64
        check_cxx_compiler_flag("-mbranch-protection=standard" myproj_MBR_PROTECTION)
        if(myproj_MBR_PROTECTION)
            target_compile_options(${target} ${visibility} "-mbranch-protection=standard")
        endif()
        check_cxx_compiler_flag("-Wtrampolines" myproj_TRAMPOLINES)
        if(myproj_TRAMPOLINES)
