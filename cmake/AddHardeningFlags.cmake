macro(smoldb_cpp_add_hardening_flags target visibility)
    ...
    if(MSVC)
        ...
        if(smoldb_cpp_ENABLE_DEBUG_OPTIMIZATION)
        ...
        check_cxx_compiler_flag("-fcf-protection=full" smoldb_cpp_FCF_PROTECTION)
        if(smoldb_cpp_FCF_PROTECTION)
            target_compile_options(${target} ${visibility} "-fcf-protection=full")
        endif()
        # -mbranch-protection is for Aarch64
        check_cxx_compiler_flag("-mbranch-protection=standard" smoldb_cpp_MBR_PROTECTION)
        if(smoldb_cpp_MBR_PROTECTION)
            target_compile_options(${target} ${visibility} "-mbranch-protection=standard")
        endif()
        check_cxx_compiler_flag("-Wtrampolines" smoldb_cpp_TRAMPOLINES)
        if(smoldb_cpp_TRAMPOLINES)
